        ...
        >
          <fieldset className='flex flex-col m-4 p-2 gap-1'>
            ...
            {errors.username?.type === 'required' && (
              <p className='text-yellow-600 text-sm font-light'>Username is required</p>
            )}
          </fieldset>
          ...
          <fieldset className='flex flex-col m-4 p-2 gap-1'>
            ...
            {errors.password?.type === 'required' && (
              <p className='text-yellow-600 text-sm font-light'>Password is required</p>
            )}
          </fieldset>

          {errorMessage && (
            <span className='bg-red-400 p-1 mb-4 rounded-lg text-white text-sm font-light w-full flex justify-center items-center gap-1'>
              <TiInfoOutline />
              {errorMessage}
            </span>
          )}
